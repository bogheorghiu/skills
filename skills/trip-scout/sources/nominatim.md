...
evidence: "2026-09-25: https://nominatim.openstreetmap.org/search?format=json&q=Costituzione&viewbox=11.35,44.52,11.375,44.505&bounded=1&extratags=1 returned way 382707838 (highway=pedestrian, Piazza della Costituzione)"
---
...
caveats: Many sandboxes cannot reach it. Then ask the user for the coordinate, or take it from listing data. Do not relay it through Apify or another API reseller: the policy names them under Reselling and requires them to run their own geocoder. Never geocode listings in bulk or in a grid, and never send the user's own address or other personal data (the policy asks for none).
drop: —
